...
class SsdataDataserviceRiskBusinesslicenseCertifyRequest
{
	...
	/** 
	 * 营业执照营业期限，两个时间段的数据，永久有效填写9999123199991231 【非图片认证时此参数必填】
	 **/
	private $expires;
	
	/** 
	 * 有效期终止时间，永久有效：99991231 【图片认证与非图片认证均可选】与expires是补充作用
	 **/
	private $expiresEnd;
	
	/** 
	 * 有效期起始时间 ，【图片认证与非图片认证均可选】与expires是补充作用
	 **/
