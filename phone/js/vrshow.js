...
//          settings['skin_settings.thumbs'] = false;
            ...
            var htl="",
                ...
                for (var i = 0; i < list.length; i++) {
                    if(i == 0) {
                         htl+='<li class="swiper-slide active" data-scene-name="'+list[i].sceneName+'"><img src="'+list[i].thumbPath+'"><p class="text-over">'+list[i].scene_title+'</p></li>';
                    }else {
                        htl+='<li class="swiper-slide" data-scene-name="'+list[i].sceneName+'"><img src="'+list[i].thumbPath+'"><p class="text-over">'+list[i].scene_title+'</p></li>';
                    }
                    // alert(htl);
                }
                $(".scenes-sw-list").empty().append(htl);
//景点场景滚动
                ...
                $(".scenes-sw-list").css({"visibility":"visible"});           
            // addThumbImg();
        }
    });
//  },500)
