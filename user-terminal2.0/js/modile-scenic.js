...
//				景区介绍
			...
			collapseSpot:function(obj){
				var cal=obj.className;
				if(cal == "swiper-down-btn") {
					$(".scenic-spot-bottom").removeClass("scenic-half-height").addClass("scenic-short-height");
...
//					$(".scenic-spot-detial").removeClass("hide-detial");
					...
					if(!$(".scenic-spot-bottom").hasClass("scenic-show-all")) {
						$(".scenic-spot-bottom").removeClass("scenic-short-height").addClass("scenic-half-height");
					}else{
						$(".scenic-spot-bottom").removeClass("scenic-short-height scenic-half-height");
					}
					obj.className = "swiper-down-btn";
				}
			},
